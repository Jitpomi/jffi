...
fn create_android_local_properties() -> Result<()> {
    use std::env;
    
    let home = env::var("HOME").context("Could not get HOME environment variable")?;
    let sdk_dir = format!("{}/Library/Android/sdk", home);
    // Escape spaces in path for Android Studio compatibility
    let jdk_dir = "/Applications/Android\\ Studio.app/Contents/jbr/Contents/Home";
    
    let content = format!(
        "## This file is automatically generated by jffi.\n\
         ## Do not modify this file -- YOUR CHANGES WILL BE ERASED!\n\
         \n\
         # Android SDK location (escape spaces for Android Studio)\n\
         sdk.dir={}\n\
         \n\
         # Gradle JDK location (Android Studio embedded JDK, spaces escaped with \\\\ )\n\
         org.gradle.java.home={}\n",
        sdk_dir, jdk_dir
    );
    
    let local_props_path = PathBuf::from("platforms/android/local.properties");
    fs::write(&local_props_path, content)?;
    
    println!("  {} Created local.properties with SDK and JDK paths", "✓".green());
